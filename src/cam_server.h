...
void setup_cam_server()
{
    ...
    cam_server.on("/bmp", HTTP_GET, sendBMP);
    cam_server.on("/capture", HTTP_GET, sendJpg);
    cam_server.on("/stream", HTTP_GET, streamJpg);
    cam_server.on("/control", HTTP_GET, setCameraVar);
    cam_server.on("/status", HTTP_GET, getCameraStatus);
    cam_server.begin();
